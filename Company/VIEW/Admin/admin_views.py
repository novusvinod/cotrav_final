...
def add_company_entity(request, id):
    if request.method == 'POST':
        ...
        if company['success'] == 1:
            return HttpResponseRedirect("/Corporate/company-billing_entities/" + corporate_id,
...
def add_company_group(request, id):
    if request.method == 'POST':
        ...
        if company['success'] == 1:
            return HttpResponseRedirect("/Corporate/company-groups/" + str(id), {'message': "Added Successfully"})
        else:
            return HttpResponseRedirect("/Corporate/company-groups/" + str(id), {'message': "Record Not Added"})
...
def add_company_subgroup(request, id):
    if request.method == 'POST':
        ...
        if company['success'] == 1:
            return HttpResponseRedirect("/Corporate/company-subgroups/" + str(id), {'message': "Added Successfully"})
        else:
            return HttpResponseRedirect("/Corporate/company-subgroups/" + str(id), {'message': "Record Not Added"})
...
def update_company_group(request, id):
    if request.method == 'POST':
        ...
        if company['success'] == 1:
            return HttpResponseRedirect("/Corporate/view-company-group/" + group_id, {'message': "Update Successfully"})
        else:
            return HttpResponseRedirect("/Corporate/view-company-group/" + group_id, {'message': "Record Not Updated"})
...
def update_company_subgroup(request, id):
    if request.method == 'POST':
        ...
        if company['success'] == 1:
            return HttpResponseRedirect("/Corporate/view-company-subgroup/" + str(id),
...
def delete_company_group(request, id):
    if request.method == 'POST':
        ...
        if company['success'] == 1:
            return HttpResponseRedirect("/Corporate/company-groups/" + str(id), {'message': "Delete Successfully"})
        else:
            return HttpResponseRedirect("/Corporate/company-groups/" + str(id), {'message': "Record Not Added"})
...
def delete_company_subgroup(request, id):
    if request.method == 'POST':
        ...
        print(payload)
        if company['success'] == 1:
            return HttpResponseRedirect("/Corporate/company-subgroups/" + str(id), {'message': "Delete Successfully"})
        else:
            return HttpResponseRedirect("/Corporate/company-subgroups/" + str(id), {'message': "Record Not Added"})
...
def add_company_group_auth(request, id):
    if request.method == 'POST':
        ...
        print(delete_id)
        if company['success'] == 1:
            return HttpResponseRedirect("/Corporate/view-company-group/" + group_id, {'message': "Added Successfully"})
        else:
            return HttpResponseRedirect("/Corporate/view-company-group/" + group_id, {'message': "Record Not Added"})
...
def add_company_subgroup_auth(request, id):
    if request.method == 'POST':
        ...
        print(company)
        if company['success'] == 1:
            return HttpResponseRedirect("/Corporate/view-company-subgroup/" + subgroup_id,
                                        {'message': "Added Successfully"})
        else:
            return HttpResponseRedirect("/Corporate/view-company-subgroup/" + subgroup_id,
                                        {'message': "Record Not Added"})
...
def add_company_admins(request, id):
    if request.method == 'POST':
        ...
        print(company)
        if company['success'] == 1:
            return HttpResponseRedirect("/Corporate/company-admins/" + str(id), {'message': "Added Successfully"})
        else:
            return HttpResponseRedirect("/Corporate/company-admins/" + str(id), {'message': "Record Not Added"})
...
def add_spocs(request, id):
    if request.method == 'POST':
        ...
        print(company)
        if company['success'] == 1:
            return HttpResponseRedirect("/Corporate/company-spocs/" + str(id), {'message': "Added Successfully"})
        else:
