...
def homepage(request):
    if 'login_type' in request.session:
        return render(request, 'Company/Approves_1/home_page.html', {'user': request.user})
    else:
...
def company_admins(request, id):
    ...
    if 'login_type' in request.session:
        ...
        if company['success'] == 1:
            ...
            return render(request, "Company/Approves_1/company_admins.html", {'admins': admins})
        else:
            return render(request, "Company/Approves_1/company_admins.html", {'admins': {}})
    else:
...
def company_billing_entities(request, id):
    ...
    if 'login_type' in request.session:
        ...
        if company['success'] == 1:
            ...
            return render(request, "Company/Approves_1/billing_entities.html",
                          {'billing_entities': entities, "cities": cities, })
        else:
            return render(request, "Company/Approves_1/billing_entities.html", {'entities': {}})
    else:
        return redirect('/login')
...
def company_rates(request, id):
    ...
    if 'login_type' in request.session:
        ...
        if company['success'] == 1:
            ...
            return render(request, "Company/Approves_1/company_rates.html", {'corporate_rates': company_rates})
        else:
            return render(request, "Company/Approves_1/company_rates.html", {'entities': {}})
    else:
        return redirect('/login')
...
def company_groups(request, id):
    ...
    if 'login_type' in request.session:
        ...
        if company['success'] == 1:
            ...
            return render(request, "Company/Approves_1/groups.html", {'groups': groups})
        else:
            return render(request, "Company/Approves_1/groups.html", {'groups': {}})
    else:
        return redirect('/login')
...
def company_subgroups(request, id):
    ...
    if 'login_type' in request.session:
        ...
        if company['success'] == 1:
            ...
            groups = gr['Groups']
            return render(request, "Company/Approves_1/subgroups.html", {'subgroups': subgroups, 'groups': groups})
        else:
            return render(request, "Company/Approves_1/subgroups.html", {'subgroups': {}})
    else:
        return redirect('/login')
...
def company_spocs(request, id):
    ...
    if 'login_type' in request.session:
        ...
        if company['success'] == 1:
            spocs = company['Spocs']
            return render(request, "Company/Approves_1/spocs.html", {'spocs': spocs})
        else:
            return render(request, "Company/Approves_1/spocs.html", {'spocs': {}})
    else:
        return redirect('/login')
...
def company_employees(request, id):
    ...
    if 'login_type' in request.session:
        ...
        if company['success'] == 1:
            ...
            return render(request, "Company/Approves_1/employees.html", {'employees': employees})
        else:
            return render(request, "Company/Approves_1/employees.html", {'employees': {}})
    else:
        return redirect('/login')
...
def view_company_group(request, id):
    ...
    if 'login_type' in request.session:
        ...
        if company['success'] == 1:
            ...
            return render(request, "Company/Approves_1/view_groups.html", {'group': groups, 'grp_auths': grp_auths})
        else:
            return render(request, "Company/Approves_1/view_groups.html", {'group': {}})
    else:
        return redirect('/login')
...
def view_company_subgroup(request, id):
    ...
    if 'login_type' in request.session:
        ...
        if company['success'] == 1:
            ...
            return render(request, "Company/Approves_1/view_subgroups.html",
                          {'subgroup': subgroups, 'subgrp_auths': subgrp_auths})
        else:
            return render(request, "Company/Approves_1/view_subgroups.html", {'group': {}})
    else:
        return redirect('/login')
...
def taxi_bookings(request,id):
    ...
    if 'login_type' in request.session:
        ...
        if company['success'] == 1:
            ...
            return render(request, "Company/Approves_1/taxi_bookings.html",{'bookings': booking})
        else:
            return render(request, "Company/Approves_1/taxi_bookings.html", {'': {}})
    else:
        return redirect('/login')
...
def view_taxi_booking(request,id):
    ...
    if 'login_type' in request.session:
        ...
        if company['success'] == 1:
            booking = company['Bookings']
            return render(request, "Company/Approves_1/view_taxi_booking.html",{'bookings': booking})
        else:
            return render(request, "Company/Approves_1/view_taxi_booking.html", {'': {}})
    else:
        return redirect('/login')
...
def bus_bookings(request,id):
    ...
    if 'login_type' in request.session:
        ...
        if company['success'] == 1:
            booking = company['Bookings']
            return render(request, "Company/Approves_1/bus_bookings.html",{'bookings': booking})
        else:
            return render(request, "Company/Approves_1/bus_bookings.html", {'': {}})
    else:
        return redirect('/login')
...
def view_bus_booking(request,id):
    ...
    if 'login_type' in request.session:
        ...
        if company['success'] == 1:
            booking = company['Bookings']
            return render(request, "Company/Approves_1/view_bus_booking.html",{'bookings': booking})
        else:
            return render(request, "Company/Approves_1/view_bus_booking.html", {'': {}})
    else:
        return redirect('/login')
