...
def get_access_details_by_corporate_name(request):
    if 'login_type' in request.session:
        ...
        if get_user_from_type == '/login' or get_user_from_type == '/' or get_user_from_type == '/index' or get_user_from_type == '/about' or get_user_from_type == '/signup' or get_user_from_type == '/contact' or get_user_from_type == '/support' or ac_user[0] == "agents":
            return {}
        else:
            if ac_user[1] == "Admin":
